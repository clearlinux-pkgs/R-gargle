...
Version  : 1.1.0
Release  : 4
URL      : https://cran.r-project.org/src/contrib/gargle_1.1.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/gargle_1.1.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1620236719
...
/usr/lib64/R/library/gargle/tests/testthat/_snaps/ui.md
...
/usr/lib64/R/library/gargle/tests/testthat/test-ui.R
